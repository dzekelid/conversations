...
apis:
- name: Microsoft Graph List Conversations
...
- name: Microsoft Graph
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/conversations/master/_listings/microsoft-graph/openapi.md
x-common:
- type: x-change-loge
